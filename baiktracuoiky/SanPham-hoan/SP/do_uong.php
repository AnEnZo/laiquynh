...
<head>
    ...
    <link rel="stylesheet" href="../css/do_uong.css">
    <style>
        footer {
            text-align: center;
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                echo '<tr>
                        ...
                        <td class="actions">
                            <a href="suado_uong.php?ID=' . $row["masp"] . '">Sửa</a> |
                            <a onclick="return confirm(\'Bạn có chắc chắn muốn xóa?\');" href="xoado_uong.php?ID=' . $row["masp"] . '">Xóa</a>
                        </td>
                    </tr>';
            }
            echo '</tbody></table>';
